...
namespace Cardholder.Cli.Credential
{
    ...
    /// </summary>
    public partial class CredentialSettings : CommandSettings
    {
        private readonly IValidator<CredentialSettings> _validation;

        public CredentialSettings(IValidator<CredentialSettings> validation)
        {
        ...
        /// </summary>
        [CommandOption($"--{nameof(UniqueKey)}")]
        ...
        /// </summary>
        [CommandOption($"--{nameof(PersonnelKey)}")]
